...
namespace MauiMultimedia.Viewers.Video.Platforms.MacCatalyst;

/// <summary>
/// MacCatalyst 原生视频首帧提取：AVAssetImageGenerator（AVFoundation）。
...
public class VideoFrameExtractor : IVideoFrameExtractor
{
    ...
    // AVAssetImageGenerator 在 .NET MacCatalyst 绑定里只有同步 CopyCGImageAtTime，
